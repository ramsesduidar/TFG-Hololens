...
namespace QRTracking
{
    ...
    public class QRCode : MonoBehaviour
    {
        ...
        /*
         * QRCode.cs - This script is attached to the QR code object 
         * and populates the text displayed in the scene with the QR code properties on Start.
        */
